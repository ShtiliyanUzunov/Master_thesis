...
def test_on_single_photo(landmark_model):
    ...
    print("Actual emotion: {} {}".format(actual_emotion, EmotionMap[str(actual_emotion)]))
    predicted_emotion = emotion_model.predict_by_landmarks(predicted_landmarks)
    print("Predicted emotion: {} {}".format(predicted_emotion, EmotionMap[str(predicted_emotion)]))
